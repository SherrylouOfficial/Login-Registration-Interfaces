...
Each interface is implemented independently and organized into its own folder for clarity and ease of review.
...
- **Button-Based Interactive UI**  
  Interactive web interface using image-based buttons (PNG assets) to explore visual feedback and user interaction.

- **Password Strength Meter Interface**  
  Client-side password strength indicator providing real-time feedback based on user input.
